// Package main exports kinet-labs/zapdb functions as a C shared library.
//
// Build:
//
...
//export kinet_zapdb_open
func kinet_zapdb_open(path *C.char, pathLen C.int, out *C.ulonglong) C.int {
...
//export kinet_zapdb_close
func kinet_zapdb_close(handle C.ulonglong) C.int {
...
//export kinet_zapdb_get
func kinet_zapdb_get(
	handle C.ulonglong,
...
//export kinet_zapdb_set
func kinet_zapdb_set(
	handle C.ulonglong,
	key *C.char, keyLen C.int,
	val *C.char, valLen C.int,
) C.int {
...
//export kinet_zapdb_delete
func kinet_zapdb_delete(
	handle C.ulonglong,
	key *C.char, keyLen C.int,
) C.int {
	db, ok := loadHandle[*badger.DB](handle)
...
//export kinet_zapdb_iterate
func kinet_zapdb_iterate(
	handle C.ulonglong,
...
//export kinet_zapdb_backup
func kinet_zapdb_backup(handle C.ulonglong, path *C.char, pathLen C.int) C.int {
	db, ok := loadHandle[*badger.DB](handle)
	if !ok {
		return -1
	}
...
//export kinet_zapdb_load
func kinet_zapdb_load(handle C.ulonglong, path *C.char, pathLen C.int) C.int {
	db, ok := loadHandle[*badger.DB](handle)
	if !ok {
		return -1
	}
...
//export kinet_zapdb_sync
func kinet_zapdb_sync(handle C.ulonglong) C.int {
	db, ok := loadHandle[*badger.DB](handle)
	if !ok {
		return -1
	}
...
//export kinet_zapdb_compact
func kinet_zapdb_compact(handle C.ulonglong) C.int {
	db, ok := loadHandle[*badger.DB](handle)
	if !ok {
		return -1
	}
...
//export kinet_zapdb_new_txn
func kinet_zapdb_new_txn(handle C.ulonglong, readOnly C.int, out *C.ulonglong) C.int {
	db, ok := loadHandle[*badger.DB](handle)
	if !ok {
		return -1
	}
...
//export kinet_zapdb_txn_commit
func kinet_zapdb_txn_commit(txnHandle C.ulonglong) C.int {
...
//export kinet_zapdb_txn_discard
func kinet_zapdb_txn_discard(txnHandle C.ulonglong) {
	txn, ok := loadHandle[*badger.Txn](txnHandle)
	if !ok {
		return
	}
...
//export kinet_zapdb_txn_get
func kinet_zapdb_txn_get(
...
//export kinet_zapdb_txn_set
func kinet_zapdb_txn_set(
	txnHandle C.ulonglong,
	key *C.char, keyLen C.int,
	val *C.char, valLen C.int,
) C.int {
